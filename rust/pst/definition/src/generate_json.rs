...
mod tests {
    ...
    fn generate_from_enum<T: IntoEnumIterator>(name: &str) -> Result<(), std::io::Error> where <T as IntoEnumIterator>::Iterator: Iterator, <<T as IntoEnumIterator>::Iterator as Iterator>::Item: Serialize {
    ...
    fn generate_json() -> Result<(), std::io::Error> {
        ...
        generate_from_enum::<ReadAction>("ReadAction")?;
        generate_from_enum::<WriteAction>("WriteAction")?;
        generate_from_enum::<ReadResponse>("ReadResponse")?;
